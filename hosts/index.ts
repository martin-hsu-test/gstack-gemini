...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, gemini, kiro, opencode, slate, cursor, openclaw];
...
export { claude, codex, factory, gemini, kiro, opencode, slate, cursor, openclaw };
