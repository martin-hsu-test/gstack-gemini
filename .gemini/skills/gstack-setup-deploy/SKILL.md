...
checks, and deploy status commands — then persist everything to GEMINI.md.

After this runs once, `/land-and-deploy` reads GEMINI.md and skips detection entirely.
...
Use ask the user to gather the information:
