...
This is **INFORMATIONAL** unless HIGH-impact discrepancies are found (then it gates via ask the user).
...
Read `.gemini/skills/gstack/review/checklist.md`.
...
2. **FALSE POSITIVE comments:** Present each one via ask the user:
